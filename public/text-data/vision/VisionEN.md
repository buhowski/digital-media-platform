...
This is the sole entry point into "Another Dimension" — an alternative operating system of reality. The project is designed to replace the daily news feed and free people from consuming informational garbage. And for those hooked on such "treats" — there will be special categories.
...
Key industry products — in comprehensive concept presentations: [Cinematic Dimension](/cinema) [Gamedev Dimension](/gamedev)
